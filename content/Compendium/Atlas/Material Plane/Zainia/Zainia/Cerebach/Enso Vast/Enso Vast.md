...
tags:
 - location/city
headerLink: "[[Enso Vast#Enso Vast]]"
---
...
> [!quote|no-t] SUMMARY
>City near The Thornwater in [[Cerebach]]
...
FROM "Compendium/Atlas/Material Plane/Zainia/Zainia/Cerebach/Enso Vast"
WHERE type= "landmark"
SORT file.name ASC
>
>> [!note]- HISTORY
>>```dataview
LIST WITHOUT ID headerLink
FROM "Session Notes" AND [[Enso Vast]]
