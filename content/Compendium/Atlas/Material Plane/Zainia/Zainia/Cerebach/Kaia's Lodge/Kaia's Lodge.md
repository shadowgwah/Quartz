...
tags:
 - location/village
headerLink: "[[Kaia's Lodge#Kaia's Lodge]]"
---
...
> [!quote|no-t] SUMMARY
>Homely little inn in the middle of nowhere.  Converted house into an inn.
...
FROM "Compendium/Atlas/Material Plane/Zainia/Zainia/Cerebach/Kaia's Lodge"
WHERE type= "landmark"
SORT file.name ASC
>
>> [!note]- HISTORY
>>```dataview
LIST WITHOUT ID headerLink
FROM "Session Notes" AND [[Kaia's Lodge]]
